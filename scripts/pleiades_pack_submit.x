...
#PBS -r n
####
#PBS -N CCSHIGHRES_pack 
#PBS -o CCSHIGHRES_pack.out 
#PBS -e CCSHIGHRES_pack.err 
#PBS -V
####
...
cp mitgcmuv_pack mitgcmuv
cp data.ctrl_pack data.ctrl
cp data.pkg_pack data.pkg

#set up optimization iteration number

mpiexec -np 126 /u/scicon/tools/bin/mbind.x ./mitgcmuv > run_pack.out 
